...
import { getBlogPostBySlug, recordBlogPostView } from "@/db/queries/blog";
import { calculateReadingMinutes } from "@/lib/reading-time";
import { Visibility } from "relume-icons";
...
export default async function NewsDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  await recordBlogPostView(post.id);
      ...
      <section className="scheme-2 px-[5%] py-20 md:py-24 lg:py-28">
        <div className="container max-w-2xl">
          <div className="mb-6 flex flex-wrap items-center gap-4">
            ...
            <p className="flex items-center gap-1.5 text-small text-neutral">
